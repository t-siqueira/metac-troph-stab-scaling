...
# save
tmap_save(tm = map1, filename = here("Figures_tables", "map1.png"), 
          wi = 30, he = 20, un = "cm", dpi = 300)

# map option 2

map2 <- tm_shape(world, 
                 bbox = st_bbox(c(xmin = -130, xmax = 40, ymax = 90, ymin = -60), crs = st_crs(4326))) +
  tm_graticules() +
  tm_polygons() +
  tm_shape(occ_vect) +
...
# save
tmap_save(tm = map2, filename = here("Figures_tables", "map2.png"), 
                                     wi = 9, he = 8, un = "in", dpi = 300)
...
ps10 <- meta.metr1.supp %>%
  ggplot(aes(y = log(CV_C_L), x = Time_step,  color = New_tr_g)) +
  geom_point(size = 5, alpha = 0.75) +
  geom_line(stat="smooth",method = "lm", formula = y ~ x, size = 1.5) +
  ylim (-2.5, 2.5) +
  xlab ("Number of time steps") +
  ylab ("Community variability (Ccv)") +
  annotate("text", x = 25, y = -2, label = "p-value (interaction) = 0.74",
           col = "black", size = 5) +
  ggtitle ("B") +
  theme_classic() +
  theme(legend.position="none") +
...
ps11 <- meta.metr1.supp %>%
  ggplot(aes(y = log(CV_S_L), x = Time_step,  color = New_tr_g)) +
  geom_point(size = 5, alpha = 0.75) +
  geom_line(stat="smooth", method = "lm", formula = y ~ x, size = 1.5) +
  ylim (-2.5, 2.5) +
  xlab ("Number of time steps") +
  ylab ("Population variability (Pcv)") +
  annotate("text", x = 25, y = -2, label = "p-value (interaction) = 0.84",
           col = "black", size = 5) +
  ggtitle ("C") +
  theme_classic() +
  theme(legend.position="none") +
...
ps12 <- meta.metr1.supp %>%
  ...
  annotate("text", x = 25, y = -1.25, label = "p-value (interaction) = 0.57",
           col = "black", size = 5) +
  ggtitle ("D") +
  theme_classic() +
  theme(legend.position="none") +
...
ps13 <- meta.metr1.supp %>%
  ...
  annotate("text", x = 25, y = -1.25, label = "p-value (interaction) = 0.06",
           col = "black", size = 5) +
  ggtitle ("E") +
  theme_classic() +
  theme(legend.position="none") +
...
ps14 <- meta.metr1.supp %>%
  ggplot(aes(y = log(CV_C_R), x = nSites,  color = New_tr_g)) +
  geom_point(size = 5, alpha = 0.75) +
  geom_line(stat="smooth",method = "lm", formula = y ~ x, size = 1.5) +
  ylim (-2.5, 2.5) +
  xlab ("Number of sites") +
  ylab ("Metacommunity variability (Mcv)") +
  annotate("text", x = 25, y = -2, label = "p-value (interaction) = 0.27",
           col = "black", size = 5) +
  ggtitle ("A") +
  theme_classic() +
  theme(axis.text = element_text(size = 17),
...
ps15 <- meta.metr1.supp %>%
  ggplot(aes(y = log(CV_C_L), x = nSites,  color = New_tr_g)) +
  geom_point(size = 5, alpha = 0.75) +
  geom_line(stat="smooth",method = "lm", formula = y ~ x, size = 1.5) +
  ylim (-2.5, 2.5) +
  xlab ("Number of sites") +
  ylab ("Community variability (Ccv)") +
  annotate("text", x = 25, y = -2, label = "p-value (interaction) = 0.28",
           col = "black", size = 5) +
  ggtitle ("B") +
  theme_classic() +
  theme(legend.position="none") +
...
ps16 <- meta.metr1.supp %>%
  ggplot(aes(y = log(CV_S_L), x = nSites,  color = New_tr_g)) +
  geom_point(size = 5, alpha = 0.75) +
  geom_line(stat="smooth", method = "lm", formula = y ~ x, size = 1.5) +
  ylim (-2.5, 2.5) +
  xlab ("Number of sites") +
  ylab ("Population variability (Pcv)") +
  annotate("text", x = 25, y = -2, label = "p-value (interaction) = 0.34",
           col = "black", size = 5) +
  ggtitle ("C") +
  theme_classic() +
  theme(legend.position="none") +
...
ps17 <- meta.metr1.supp %>%
  ggplot(aes(y = log(phi_C_L2R), x = nSites,  color = New_tr_g)) +
  geom_point(size = 5, alpha = 0.75) +
  geom_line(stat="smooth",method = "lm", formula = y ~ x, size = 1.5) +
  ylim (-1.5, 0.15) +
  xlab ("Number of sites") +
  ylab ("Community spatial synchrony (Csy)") +
  annotate("text", x = 25, y = -1.25, label = "p-value (interaction) = 0.13",
           col = "black", size = 5) +
  ggtitle ("D") +
  theme_classic() +
  theme(legend.position="none") +
...
ps18 <- meta.metr1.supp %>%
  ...
  xlab ("Number of sites") +
  ylab ("Local population synchrony (Psy)") +
  annotate("text", x = 25, y = -1.25, label = "p-value (interaction) = 0.36",
           col = "black", size = 5) +
  ggtitle ("E") +
  theme_classic() +
  theme(legend.position="none") +
