# Reference --
#
# Wang S, Lamy T, Hallett LM and Loreau M (2019) Stability and 
# synchrony across ecological hierarchies in heterogeneous 
# metacommunities: linking theory to data.
# Ecography. doi: 10.1111/ecog.04290.

var.partition <- function(metacomm_tsdata){
  ## The function "var.partition" performs the partitioning of 
  ## variability across hierarchical levesl within a metacommunity.
  ...
  ## M local communities. The output includes four variability and 
  ## four synchrony metrics as defined in the main text.
  ## Note that, to be able to handle large metacommunities, this code 
  ## has avoided calculating all covariance.
  ...
  partition_3level <- c(CV_S_L=CV_S_L, CV_C_L=CV_C_L, CV_S_R=CV_S_R, 
                        CV_C_R=CV_C_R, phi_S_L2R=phi_S_L2R, 
                        phi_C_L2R=phi_C_L2R, phi_S2C_L=phi_S2C_L, 
                        phi_S2C_R=phi_S2C_R)
